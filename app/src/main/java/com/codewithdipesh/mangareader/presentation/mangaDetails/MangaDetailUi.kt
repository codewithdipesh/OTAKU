...
data class MangaDetailUi(
    ...
    val genres: List<Map<String,String>> = emptyList(), //id->name
    val themes: List<Map<String,String>> = emptyList(), //id->name
    ...
    val isSimilarMangaFetched : Boolean = false,
    ...
    val similarMangas : List<Manga> = emptyList()
)
